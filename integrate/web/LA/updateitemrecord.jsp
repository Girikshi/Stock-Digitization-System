...
window.location.href = "http://localhost:8080/integrate/LA/updaterecord.jsp?demo=<%=request.getParameter("demo")%>&dn=<%=request.getParameter("dn")%>&useri=<%=request.getParameter("useri")%>";</script>
<%

}else{

int j=st.executeUpdate("update items set status='"+status+"',extra='"+rmk+"',purchase_date='"+pd+"',purchase_num='"+pn+"' where dsrno='"+dsrno+"' and lab_id="+demo+"");
