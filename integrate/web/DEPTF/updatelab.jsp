		...
		<div class="container-login1001">
			<div class="wrap-login100">
					...
					<span class="login100-form-title-1">
						<center>UPDATE&nbsp;&nbsp;LABORATORY<center>
					</span>
				</div>
...
%> 
<form action="updatelabs.jsp?demo=<%=request.getParameter("demo")%>&dn=<%=request.getParameter("dn")%>&useri=<%=request.getParameter("useri")%>" method="post">

                              <h4 style="color:green;">SELECT DEPARTMENTWISE LAB TO UPDATE</h4><br></br>
    ...
    try
    {
        ...
        pstmt=con.prepareStatement("select lab_id,lab_name from labs where dept_name="+dn+""); //sql select query
    ...
    %>
        ...
        <br>
        <h4 style="color:red;">ENTER NEW DATA TO UPDATE SELECTED LAB </h4><br></br>

    <label>Lab Id :</label>
        <input type="text" name="lid" placeholder="Lab ID" required/>
        <br><br><br><br>
        <label>Lab Name :</label>
        <input type="text" name="lname" placeholder="Lab Name" required/>   
        <br><br><br><br><br><br>
