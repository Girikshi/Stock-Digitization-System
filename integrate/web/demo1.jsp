...
<div class="main">
    ...
    <li style="font-size: 17px;"><a href="" style="background-color:transparent;color:darkblue"><i class="fa fa-fw fa-user"></i> Item Category</a>
      <ul class="submenu">
        ...
        <li style="font-size: 15px;"><a href="DEPTF/CAT/delh.jsp?demo=<%=request.getParameter("demo")%>&dn=<%=request.getParameter("dn")%>&useri=<%=request.getParameter("useri")%>" target = "Main">Delete</a></li>
      </ul>
    </li> 
