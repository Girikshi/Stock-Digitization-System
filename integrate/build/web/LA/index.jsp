...
%> 
<form action="insertitem.jsp?demo=<%=request.getParameter("demo")%>&dn=<%=request.getParameter("dn")%>&useri=<%=request.getParameter("useri")%>" method="post">
    ...
    try
    {
        ...
        pstmt=con.prepareStatement("select distinct cat from category where dept_name="+request.getParameter("dn")+" "); //sql select query
    ...
    <option selected="selected" value="9999">Select Type</option>
        ...
        <br><br><br><br><br>
        <label>Mech :</label>
        <textarea class="ta" name="rmk" required="required" placeholder="Mech"></textarea>
         <br><br><br><br>
