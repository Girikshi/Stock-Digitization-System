...
<div class="main">
    ...
    <li style="font-size:17px"><a href="#" style="color:white;">Home</a></li>
     <li style="font-size:17px;float: right;"><a href="http://localhost:8080/integrate/index.jsp" style="color:white;">LogOut</a></li>

    </ul><div style="height:100%;">
        <iframe height="480" style="width:82%" src="index_1.html?demo=<%=request.getParameter("demo")%>&dn=<%=request.getParameter("dn")%>&useri=<%=request.getParameter("useri")%>" align="right" frameborder = "0"   name = "Main" allowtransparency="true">
        </iframe></div>		
    ...
    <li style="font-size: 17px;margin-top: 15px;"><a href="" style="background-color:transparent;color:darkblue"><i class="fa fa-fw fa-user"></i>My Profile</a>
      <ul class="submenu">
        <li style="font-size: 15px;"><a href="profile/Myprofile.jsp" target = "Main">View Profile</a></li>
    ...
    <li style="font-size: 17px;"><a href="" style="background-color:transparent;color:darkblue"><i class="fa fa-fw fa-user"></i> Users</a>
      <ul class="submenu">
        <li style="font-size: 15px;"><a href="DEPTF/addla.jsp?demo=<%=request.getParameter("demo")%>&dn=<%=request.getParameter("dn")%>&useri=<%=request.getParameter("useri")%>" target = "Main">Add</a></li>
        <li style="font-size: 15px;"><a href="DEPTF/updatela.jsp?demo=<%=request.getParameter("demo")%>&dn=<%=request.getParameter("dn")%>&useri=<%=request.getParameter("useri")%>" target = "Main">Update</a></li>
        <li style="font-size: 15px;"><a href="DEPTF/deluser.jsp?demo=<%=request.getParameter("demo")%>&dn=<%=request.getParameter("dn")%>&useri=<%=request.getParameter("useri")%>" target = "Main">Delete</a></li>
      </ul>
    </li>
    <li style="font-size: 17px;"><a href="" style="background-color:transparent;color:darkblue"><i class="fa fa-fw fa-user"></i> Laboratory</a>
      <ul class="submenu">
        <li style="font-size: 15px;"><a href="DEPTF/addlab.jsp?demo=<%=request.getParameter("demo")%>&dn=<%=request.getParameter("dn")%>&useri=<%=request.getParameter("useri")%>" target = "Main">Add</a></li>
        <li style="font-size: 15px;"><a href="DEPTF/updatelab.jsp?demo=<%=request.getParameter("demo")%>&dn=<%=request.getParameter("dn")%>&useri=<%=request.getParameter("useri")%>" target = "Main">Update</a></li>
        <li style="font-size: 15px;"><a href="DEPTF/della.jsp?demo=<%=request.getParameter("demo")%>&dn=<%=request.getParameter("dn")%>&useri=<%=request.getParameter("useri")%>" target = "Main">Delete</a></li>
      </ul>
    </li>
    ...
    <li style="font-size:17px"><a href="" style="background-color:transparent;color:darkblue;"><i class="fa fa-file-text"></i> Repair ( Item ) </a>
      <ul class="submenu">
        <li style="font-size:15px"><a href="repair1/repairs.jsp?demo= target = "Main"> Send ( Item ) </a></li>
        <li style="font-size:15px"><a href="repair1/repairr.jsp?demo= target = "Main"> Receive ( Item ) </a></li>
