...
%> 
<form action="updatelas.jsp?demo=<%=request.getParameter("demo")%>&dn=<%=request.getParameter("dn")%>&useri=<%=request.getParameter("useri")%>" method="post">
                    <h4 style="color:green;">ENTER USERID TO BE UPDATED</h4><br>

      <label>UserId :</label>
           <input type="text" name="uid" placeholder="User ID" required/>
           <br><br><br><br>
       <h4 style="color:red;">ENTER NEW DATA FOR USER</h4><br>
    ...
    try
    {
        ...
        pstmt=con.prepareStatement("select distinct lab_name,lab_id from labs where dept_name="+dn+""); //sql select query
