...
<div class="main">
    ...
    <li style="font-size:17px"><a href="#" style="color:white;">Home</a></li>
     <li style="font-size:17px;float: right;"><a href="http://localhost:8080/integrate/index.jsp" style="color:white;">LogOut</a></li>
        ...
        <iframe height="492" style="width:80%;" src="indexhod.html?demo=<%=request.getParameter("demo")%>&dn=<%=request.getParameter("dn")%>&useri=<%=request.getParameter("useri")%>" align="right" frameborder = "0"   name = "Main" allowtransparency="true">
        </iframe></div>	
    ...
    <li style="font-size: 17px;"><a href="" style="background-color:transparent;color:darkblue"><i class="fa fa-file-text"></i> Generate report</a>
      <ul class="submenu">
        <li style="font-size: 15px;"><a href="View/optitem.jsp"  target = "Main">Item wise</a></li>
        <li style="font-size: 15px;"><a href="View/optlab.jsp"  target = "Main">Lab wise</a></li>
        <li style="font-size: 15px;"><a href="View/optdept.jsp"  target = "Main">Department wise</a></li>      </ul>
