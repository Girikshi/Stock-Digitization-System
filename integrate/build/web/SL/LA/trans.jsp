...
<body style="background:none;">	
	...
	<select class="dept" onchange="dept_change()" name="category">
    ...
    %>
        ...
        <label>Lab ID ( From ) :</label> 
	<select class="lab" name="labno">
         <option selected="selected" value="9999">Select Labid</option>
        ...
        <br><br><br><br>
                        ...
                        <label>Lab ID ( To ) :</label> 
                        <select class="lab" name="labno2">
         <option selected="selected" value="9999">Select Labid</option>
 	</select>
        <br><br><br><br>
