...
%>    
  <form action="updatelabs.jsp?demo=<%=request.getParameter("demo")%>&dn=<%=request.getParameter("dn")%>&useri=<%=request.getParameter("useri")%>" method="post">
              ...
              <h4 style="color:green;padding-bottom: 20px;padding-top: 10px;">SELECT DEPARTMENTWISE LAB TO UPDATE :</h4>
...
<h4 style="color:red;">ENTER NEW DATA FOR SELECTED LAB : </h4><br>
    <label>LabId :</label>
