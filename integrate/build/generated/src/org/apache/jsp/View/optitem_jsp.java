...
public final class optitem_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("{\n");
      out.write("    var x = document.forms[\"f1\"][\"cate\"].value;\n");
      out.write("    if (x == \"0\") \n");
      out.write("    {\n");
      out.write("        alert(\"Item category must be filled out\");\n");
      out.write("         form.action = \"optitem.jsp?demo=");
      ...
      out.write("    else\n");
      out.write("    {\n");
      out.write("        form.action = \"itempdf.jsp?demo=");
      out.print(request.getParameter("demo"));
      out.write("&dn=");
      out.print(request.getParameter("dn"));
      out.write("&useri=");
      ...
      out.write("    else\n");
      out.write("    {\n");
      out.write("        form.action = \"hodItemChart.jsp?demo=");
      out.print(request.getParameter("demo"));
      out.write("&dn=");
      out.print(request.getParameter("dn"));
      out.write("&useri=");
      ...
      out.write("\t\t\t\t\t<center>Generate Item wise Reports for department ");
      out.print(request.getParameter("dn"));
      out.write("<center>\n");
      out.write("\t\t\t\t\t</span>\n");
      out.write("\t\t\t\t</div>\n");
...
String dnm=request.getParameter("dn");
      ...
      out.write("            <option value=\"0\">Select item category</option>\n");
      out.write("            ");

                String q="select distinct sub_cat from items where dept_name="+dnm+"";
...
try
{
    Class.forName("com.mysql.jdbc.Driver");
      ...
      out.print(rs.getString("sub_cat"));
      out.write('"');
      out.write('>');
      out.print(rs.getString("sub_cat"));
      out.write("</option>\n");
