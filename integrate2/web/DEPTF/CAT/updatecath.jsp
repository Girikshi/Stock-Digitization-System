		...
		<div class="container-login1001">
			<div class="wrap-login100">
					...
					<span class="login100-form-title-1">
						<center>UPDATE&nbsp;&nbsp;ITEM&nbsp;&nbsp;CATEGORY<center>
					</span>
				</div>
...
%>    
   <form action="updatecat.jsp?demo=<%=request.getParameter("demo")%>&dn=<%=request.getParameter("dn")%>&useri=<%=request.getParameter("useri")%>" method="post">
             <h4 style="color:green;">SELECT ITEM CATEGORY TO UPDATE</h4><br>
	<label>Category :</label> 
	<select class="country" onchange="country_change()" name="category">
    <option selected="selected" value="9999">Select Maincategory</option>
	<%
    try
    {
        ...
        pstmt=con.prepareStatement("select distinct cat from category"); //sql select query
        ResultSet rs;
	...
	<label>Subcategory:</label> 
        <select class="state" onchange="state_change()" name="subcategory">
            <option selected="selected" value="9999">Select Subcategory</option>
	</select>
        <br><br><br><br>
	<label>Type :</label> 
	<select class="city" name="sub_subcategory">
    <option selected="selected" value="9999">Select Type</option>
	</select>
        <br><br><br><br><br>
           <h4 style="color:red;">ENTER NEW DATA FOR SELECTED CATEGORY</h4><br></br>
               
        <label>Mech :</label>
            <input type="text" name="mech" required placeholder="Mech"/>
        <br><br><br><br>
        <label>Specification :</label>
            <input type="text" name="spec" required placeholder="Specifications"/>
        <br><br><br><br>
