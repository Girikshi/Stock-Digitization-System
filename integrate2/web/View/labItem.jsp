    ...
    function handleClick1( form )
{
    ...
    {
        form.action = "labPDF1.jsp?demo=<%=request.getParameter("demo")%>&dn=<%=request.getParameter("dn")%>&useri=<%=request.getParameter("useri")%>";
        form.target="_blank";
    ...
    function handleClick2( form )
{
    ...
    {
        form.action = "labChart1.jsp?demo=<%=request.getParameter("demo")%>&dn=<%=request.getParameter("dn")%>&useri=<%=request.getParameter("useri")%>";
        form.target="_blank";
	...
	<div class="limiter">	
		<div class="container-login1001">
			<div class="wrap-login100">
					...
					<center>Generate &nbspItem &nbspwise &nbspReports &nbspfor &nbsplab <%=request.getParameter("demo")%><center>
					</span>
				</div>
...
<form name="f1" method="POST" >
    ...
    <select name="cate" id="cate" >
            ...
            <%
                String q="select distinct sub_cat from items where lab_id="+lab+"";
