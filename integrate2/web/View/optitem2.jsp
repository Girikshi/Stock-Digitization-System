    ...
    function handleClick1( form )
{
    ...
    {
        form.action = "itempdf2.jsp?demo=<%=request.getParameter("demo")%>&dn=<%=request.getParameter("dn")%>&useri=<%=request.getParameter("useri")%>";
        form.target="_blank";
    ...
    function handleClick2( form )
{
    ...
    {
        form.action = "hodItemChart2.jsp?demo=<%=request.getParameter("demo")%>&dn=<%=request.getParameter("dn")%>&useri=<%=request.getParameter("useri")%>";
        form.target="_blank";
...
<form name="f1"  method="post">
    ...
    <select name="cate" id="cate" >
            ...
            <%
                String q="select distinct sub_cat from items join category where items.type=category.type";
