...
%>    
  <form action="addlabs.jsp?demo=<%=request.getParameter("demo")%>&dn=<%=request.getParameter("dn")%>&useri=<%=request.getParameter("useri")%>" method="post">
	<label>LabId :</label>
    <input type="text" name="lid" placeholder="Name" required/>
    <br><br><br><br>
<label>LabName :</label>
