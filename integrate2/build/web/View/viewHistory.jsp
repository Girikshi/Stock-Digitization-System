    ...
    function handleClick1( form )
{
    ...
    {
        form.action = "HistoryCard.jsp?demo=<%=request.getParameter("demo")%>&dn=<%=request.getParameter("dn")%>&useri=<%=request.getParameter("useri")%>";
        form.target="_blank";
		...
		<div class="container-login1001">
			<div class="wrap-login100">
					...
					<span class="login100-form-title-1">
						<center> history &nbsp&nbspcard<center>
					</span>
				</div>
...
%>
  <form name="f1" method="post">
    ...
    %>
        ...
        <br><br><br><br>
       <input type='submit' value='View History' onclick=handleClick1(this.form)>     
